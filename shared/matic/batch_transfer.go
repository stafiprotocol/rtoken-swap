...
// Erc20TokenAddress is a free data retrieval call binding the contract method 0x524df7ba.
//
// Solidity: function _erc20TokenAddress() view returns(address)
func (_BatchTransfer *BatchTransferCaller) Erc20TokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _BatchTransfer.contract.Call(opts, &out, "_erc20TokenAddress")
...
//
// Solidity: function _erc20TokenAddress() view returns(address)
func (_BatchTransfer *BatchTransferSession) Erc20TokenAddress() (common.Address, error) {
...
//
// Solidity: function _erc20TokenAddress() view returns(address)
func (_BatchTransfer *BatchTransferCallerSession) Erc20TokenAddress() (common.Address, error) {
	return _BatchTransfer.Contract.Erc20TokenAddress(&_BatchTransfer.CallOpts)
}

// Id is a free data retrieval call binding the contract method 0x05180237.
//
// Solidity: function _id() view returns(uint256)
func (_BatchTransfer *BatchTransferCaller) Id(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BatchTransfer.contract.Call(opts, &out, "_id")
...
//
// Solidity: function _id() view returns(uint256)
func (_BatchTransfer *BatchTransferSession) Id() (*big.Int, error) {
	return _BatchTransfer.Contract.Id(&_BatchTransfer.CallOpts)
}

// Id is a free data retrieval call binding the contract method 0x05180237.
//
// Solidity: function _id() view returns(uint256)
func (_BatchTransfer *BatchTransferCallerSession) Id() (*big.Int, error) {
	return _BatchTransfer.Contract.Id(&_BatchTransfer.CallOpts)
}
...
// Timestamp is a free data retrieval call binding the contract method 0x669475b7.
//
// Solidity: function _timestamp() view returns(uint256)
func (_BatchTransfer *BatchTransferCaller) Timestamp(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BatchTransfer.contract.Call(opts, &out, "_timestamp")
...
//
// Solidity: function _timestamp() view returns(uint256)
func (_BatchTransfer *BatchTransferSession) Timestamp() (*big.Int, error) {
	return _BatchTransfer.Contract.Timestamp(&_BatchTransfer.CallOpts)
}

// Timestamp is a free data retrieval call binding the contract method 0x669475b7.
//
// Solidity: function _timestamp() view returns(uint256)
func (_BatchTransfer *BatchTransferCallerSession) Timestamp() (*big.Int, error) {
	return _BatchTransfer.Contract.Timestamp(&_BatchTransfer.CallOpts)
}
...
//
// Solidity: function changeErc20TokenAddress(address erc20TokenAddress) returns()
func (_BatchTransfer *BatchTransferTransactor) ChangeErc20TokenAddress(opts *bind.TransactOpts, erc20TokenAddress common.Address) (*types.Transaction, error) {
	return _BatchTransfer.contract.Transact(opts, "changeErc20TokenAddress", erc20TokenAddress)
}

// ChangeErc20TokenAddress is a paid mutator transaction binding the contract method 0x654fd3fd.
//
// Solidity: function changeErc20TokenAddress(address erc20TokenAddress) returns()
func (_BatchTransfer *BatchTransferSession) ChangeErc20TokenAddress(erc20TokenAddress common.Address) (*types.Transaction, error) {
	return _BatchTransfer.Contract.ChangeErc20TokenAddress(&_BatchTransfer.TransactOpts, erc20TokenAddress)
}

// ChangeErc20TokenAddress is a paid mutator transaction binding the contract method 0x654fd3fd.
//
// Solidity: function changeErc20TokenAddress(address erc20TokenAddress) returns()
func (_BatchTransfer *BatchTransferTransactorSession) ChangeErc20TokenAddress(erc20TokenAddress common.Address) (*types.Transaction, error) {
	return _BatchTransfer.Contract.ChangeErc20TokenAddress(&_BatchTransfer.TransactOpts, erc20TokenAddress)
}
